...
public record RunResponse
{
    ...
    /// <summary>The highest sequence number appended to this Run's status update log so far. A client
    /// that already holds up to this sequence has nothing new to poll for.</summary>
    public required long LastSeq { get; init; }

    /// <summary>Who triggered this Run. Null for a Scheduled Run -- a system timer has no user id.</summary>
