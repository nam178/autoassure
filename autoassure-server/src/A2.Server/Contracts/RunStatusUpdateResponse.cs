...
/// <summary>One entry of a Run's status update log, as returned to the client. The API hands these back
...
public record RunStatusUpdateResponse
{
    ...
    /// <summary>Set when Kind is AppendActivityResult -- the only kind today, so always set in
    /// practice.</summary>
