...
/// <summary>The outcome of one Activity within a Run, as sent by a worker appending a status update and
...
/// not the live Scenario or Activity, which may since have changed or been deleted.</summary>
