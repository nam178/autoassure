...
/// <summary>A Scenario as it was when a Run was created, together with its Activities in order, as
/// returned to the client. Never changes when the live Scenario is edited or deleted afterward.</summary>
