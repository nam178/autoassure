...
/// <summary>
///     Persists AutoAssure user accounts. Storage-agnostic — callers only
///     ever see the User domain model.
/// </summary>
public interface IUserRepository
{
    /// <summary>
    ///     Looks up the user who previously signed in with this Google account,
    ///     or null if none has.
    /// </summary>
