...
/// <summary>
///     Persists Activities, scoped to their owning Scenario. Storage-agnostic —
///     callers only ever
///     see the Activity domain model.
/// </summary>
public interface IActivityRepository
{
    /// <summary>
    ///     Creates the Activity, after verifying its Scenario exists, its Scenario
    ///     hasn't
    ///     reached <see cref="Common.Quota.MaxActivityCountPerScenario" />, and every
    ///     referenced
    ///     Precondition/EvidenceDefinition exists. Atomically increments the
    ///     Scenario's Activity
    ///     count.
    /// </summary>
    ...
    ///     <see cref="Activity.Order" />.
    /// </summary>
    Task<IReadOnlyList<Activity>> ListByScenarioAsync(
        Guid organizationId,
        Guid scenarioId
    );
