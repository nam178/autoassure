...
/// the Run: the sparse in-flight lookup this comes from is built to answer "which Run" cheaply, not "what
/// is this Run", so a caller that needs the full picture makes its own follow-up Get Run.</summary>
