...
/// <summary>
///     Configuration for the app's own auth tokens, issued by
///     <c>AuthTokenService</c> after a user
...
public record AuthTokenOptions
{
    ...
    /// <summary>
    ///     Issuer claim (`iss`) on issued access tokens, and the value required
    ///     to accept one.
    /// </summary>
    public string Issuer { get; init; } = "";

    /// <summary>
    ///     Audience claim (`aud`) on issued access tokens, and the value required
    ///     to accept one.
    /// </summary>
