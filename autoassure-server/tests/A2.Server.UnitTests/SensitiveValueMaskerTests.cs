...
public sealed class SensitiveValueMaskerTests
{
    ...
    [InlineData(
        ...
        "ab********"
    )] // a long value: still capped at 2 leading characters, not a fraction of its own length
